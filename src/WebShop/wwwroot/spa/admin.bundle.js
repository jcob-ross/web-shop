...
/***/ function(module, exports, __webpack_require__) {
	...
	var admin_1 = __webpack_require__(737);
	var admin_2 = __webpack_require__(737);
	var shared_1 = __webpack_require__(163);
	var shared_2 = __webpack_require__(252);
	if (false) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var menu_1 = __webpack_require__(851);
	var message_1 = __webpack_require__(852);
	var tooltip_1 = __webpack_require__(855);
	var popup_1 = __webpack_require__(854);
	var modal_1 = __webpack_require__(853);
	var segment_1 = __webpack_require__(859);
	var list_1 = __webpack_require__(849);
	var button_1 = __webpack_require__(841);
	var item_1 = __webpack_require__(848);
	var visibility_1 = __webpack_require__(863);
	var dropdown_1 = __webpack_require__(845);
	var select_1 = __webpack_require__(860);
	var search_1 = __webpack_require__(858);
	var loader_1 = __webpack_require__(850);
	var card_1 = __webpack_require__(842);
	var input_1 = __webpack_require__(847);
	var sidebar_1 = __webpack_require__(861);
	var tab_1 = __webpack_require__(862);
	var flag_1 = __webpack_require__(846);
	var contextmenu_1 = __webpack_require__(843);
	var progress_1 = __webpack_require__(856);
	var dimmer_1 = __webpack_require__(844);
	var accordion_1 = __webpack_require__(840);
	var rating_1 = __webpack_require__(857);
	...
	__export(__webpack_require__(858));
	...
	__export(__webpack_require__(861));
	__export(__webpack_require__(862));
	__export(__webpack_require__(846));
	__export(__webpack_require__(856));
	__export(__webpack_require__(844));
...
/***/ function(module, exports, __webpack_require__) {
	...
	__export(__webpack_require__(885));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ng_semantic_1 = __webpack_require__(181);
	var AdminComponent = (function () {
	    ...
	    AdminComponent = __decorate([
	        core_1.Component({
	            ...
	            directives: [router_1.ROUTER_DIRECTIVES, ng_semantic_1.SEMANTIC_COMPONENTS, ng_semantic_1.SEMANTIC_DIRECTIVES]
	        }), 
	        __metadata('design:paramtypes', [])
	    ], AdminComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(180);
	var core_1 = __webpack_require__(1);
	var categories_1 = __webpack_require__(867);
	var manufacruters_1 = __webpack_require__(868);
	var tags_1 = __webpack_require__(886);
	var orders_1 = __webpack_require__(870);
	var products_1 = __webpack_require__(881);
	var shared_1 = __webpack_require__(252);
	var ProductAvailableGuard = (function () {
	    function ProductAvailableGuard(appState, router) {
	    ...
	    ProductAvailableGuard = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof shared_1.AdminAppState !== 'undefined' && shared_1.AdminAppState) === 'function' && _a) || Object, (typeof (_b = typeof router_1.Router !== 'undefined' && router_1.Router) === 'function' && _b) || Object])
	...
	exports.routes = [
	    ...
	    { path: 'orders', component: orders_1.OrdersComponent,
	        children: [
	            ...
	            { path: 'overview', component: orders_1.OrdersOverviewComponent }
	        ]
	    },
	    {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoriesComponent = (function () {
	    function CategoriesComponent(api, fb) {
	        ...
	        this.xhrNotificationMessage = '';
	        this.xhrPending = false;
	        this.showConfirmDelete = false;
	        // view helper for error messages
	        this.fieldRules = fieldRules;
	    }
	    CategoriesComponent.prototype.onCreateNewCategory = function () {
	    ...
	    CategoriesComponent.prototype.onCategoryClick = function (category) {
	        ...
	        this.urlSegment = new forms_1.FormControl('', forms_1.Validators.compose([
	            forms_1.Validators.required,
	            forms_1.Validators.minLength(fieldRules.urlSegment.minLength),
	            forms_1.Validators.maxLength(fieldRules.urlSegment.maxLength),
	        ]));
	        ...
	        this.viewDisplayOrder = new forms_1.FormControl('', forms_1.Validators.compose([
	            forms_1.Validators.required,
	    ...
	    CategoriesComponent.prototype.onFormSubmit = function (formValue) {
	        ...
	        if (formValue.id >= 0) {
	            this.xhrSub = this.api.updateCategory(formValue).subscribe(function (res) {
	                var updatedCategory = res.json();
	                var categoryIndex = _this.categories.findIndex(function (c) { return c.id === updatedCategory.id; });
	                _this.categories[categoryIndex] = updatedCategory;
	                _this.onCategoryClick(_this.categories[categoryIndex]);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Category created');
	            }, function (err) {
	                _this.notifyCompleted('Failed to create category', false);
	                _this.addErrors(err);
	            });
	        }
	        else {
	            this.xhrSub = this.api.createCategory(formValue).subscribe(function (res) {
	                _this.categories.push(res.json());
	                _this.onCategoryClick(_this.categories[_this.categories.length - 1]);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Category updated');
	            }, function (err) {
	                _this.notifyCompleted('Failed to update category', false);
	                _this.addErrors(err);
	            });
	        }
	    };
	    CategoriesComponent.prototype.onDeleteClick = function () {
	        this.showConfirmDelete = true;
	    };
	    CategoriesComponent.prototype.onConfirmDeleteOk = function () {
	        var _this = this;
	        this.ensureXhrCancelled();
	        this.xhrPending = true;
	        this.showConfirmDelete = false;
	        var id = this.id.value;
	        this.xhrSub = this.api.deleteCategory(id).subscribe(function (res) {
	            _this.categories.splice(_this.categories.findIndex(function (c) { return c.id === id; }), 1);
	            _this.selectedCategory = null;
	            _this.form = null;
	            _this.xhrPending = false;
	            _this.notifyCompleted('Category deleted');
	            _this.onCategoryClick(null);
	        }, function (err) {
	            _this.notifyCompleted('Failed to delete category', false);
	            _this.addErrors(err);
	        });
	    };
	    CategoriesComponent.prototype.onConfirmDeleteCancel = function () {
	        this.showConfirmDelete = false;
	    };
	    ...
	    CategoriesComponent.prototype.notifyCompleted = function (message, success, durationMs) {
	        var _this = this;
	        ...
	        this.xhrNotificationTimeoutHandle = setTimeout(function () {
	            _this.xhrNotificationVisible = false;
	        }, durationMs);
	    };
	    CategoriesComponent.prototype.ensureXhrCancelled = function () {
	    ...
	    CategoriesComponent = __decorate([
	        core_1.Component({
	            ...
	            directives: [forms_1.REACTIVE_FORM_DIRECTIVES, ng_semantic_1.SEMANTIC_COMPONENTS, ng_semantic_1.SEMANTIC_DIRECTIVES],
	            encapsulation: core_1.ViewEncapsulation.None,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ManufacturersComponent = (function () {
	    ...
	    ManufacturersComponent.prototype.onNewManufacturerClick = function (category) {
	    ...
	    ManufacturersComponent.prototype.onFormSubmit = function (formValue) {
	        ...
	        this.xhrPending = true;
	        if (formValue.id >= 0) {
	            this.xhrSub = this.api.updateManufacturer(formValue).subscribe(function (res) {
	                var updatedManufacturer = res.json();
	                var category = _this.categories.find(function (c) { return c.id === updatedManufacturer.parentCategoryId; });
	                var manufacturerIndex = category.manufacturers.findIndex(function (m) { return m.id === updatedManufacturer.id; });
	                category.manufacturers[manufacturerIndex] = updatedManufacturer;
	                _this.onManufacturerClick(_this.selectedCategory, updatedManufacturer);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Manufacturer updated');
	            }, function (err) {
	                _this.notifyCompleted('Failed to update manufacturer', false);
	                _this.addErrors(err);
	            });
	        }
	        else {
	            this.xhrSub = this.api.createManufacturer(formValue).subscribe(function (res) {
	                var createdManufacturer = res.json();
	                var category = _this.categories.find(function (c) { return c.id === createdManufacturer.parentCategoryId; });
	                category.manufacturers.push(createdManufacturer);
	                _this.onManufacturerClick(_this.selectedCategory, createdManufacturer);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Manufacturer created');
	            }, function (err) {
	                _this.notifyCompleted('Failed to create manufacturer', false);
	                _this.addErrors(err);
	            });
	        }
	    };
	    ManufacturersComponent.prototype.onDeleteClick = function () {
	        this.showConfirmDelete = true;
	    };
	    ManufacturersComponent.prototype.onConfirmDeleteOk = function () {
	        var _this = this;
	        this.ensureXhrCancelled();
	        this.xhrPending = true;
	        this.showConfirmDelete = false;
	        var id = this.id.value;
	        this.xhrSub = this.api.deleteManufacturer(id).subscribe(function (res) {
	            ...
	            _this.form = null;
	            _this.xhrPending = false;
	            _this.notifyCompleted('Manufacturer deleted');
	        }, function (err) {
	            _this.notifyCompleted('Failed to delete manufacturer', false);
	            _this.addErrors(err);
	        });
	    };
	    ManufacturersComponent.prototype.onConfirmDeleteCancel = function () {
	        this.showConfirmDelete = false;
	    };
	    ...
	    ManufacturersComponent.prototype.notifyCompleted = function (message, success, durationMs) {
	        var _this = this;
	        if (success === void 0) { success = true; }
	        if (durationMs === void 0) { durationMs = 2500; }
	        this.xhrNotificationVisible = true;
	    ...
	    ManufacturersComponent.prototype.ensureXhrCancelled = function () {
	        if (this.xhrSub && this.xhrSub.unsubscribe && !this.xhrSub.isUnsubscribed) {
	            this.xhrSub.unsubscribe();
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ng_semantic_1 = __webpack_require__(181);
	var shared_1 = __webpack_require__(163);
	var OrdersOverviewComponent = (function () {
	    function OrdersOverviewComponent(api, fb) {
	        this.api = api;
	        this.fb = fb;
	        this.xhrPending = false;
	    }
	    OrdersOverviewComponent.prototype.onOrderRowClick = function (order) {
	        console.log(order);
	        this.selectedOrder = order;
	    };
	    OrdersOverviewComponent.prototype.extractOrdersStats = function (orders) {
	        var stats = {
	            total: orders.length,
	            accepted: 0,
	            cancelled: 0,
	    ...
	    OrdersOverviewComponent.prototype.onFetchClick = function () {
	        if (!this.form.valid) {
	            return;
	        }
	        this.fetchOrders(this.maxAgeDays.value, this.shippedOnly.value);
	    };
	    OrdersOverviewComponent.prototype.onMaxAgeButtonClick = function (value) {
	        if (!this.maxAgeDays.valid) {
	            return;
	        }
	        this.maxAgeDays.updateValue(+this.maxAgeDays.value + value);
	    };
	    OrdersOverviewComponent.prototype.createForm = function () {
	        var _this = this;
	        this.shippedOnly = new forms_1.FormControl(false);
	        this.maxAgeDays = new forms_1.FormControl(7, forms_1.Validators.pattern('[0-9]{1,4}'));
	        this.shippedOnlySub = this.shippedOnly.valueChanges
	            .subscribe(function (value) {
	            if (_this.form.valid) {
	                _this.fetchOrders(_this.maxAgeDays.value, _this.shippedOnly.value);
	            }
	        });
	        this.form = this.fb.group({
	    ...
	    OrdersOverviewComponent.prototype.fetchOrders = function (maxAgeDays, onlyShipped) {
	        var _this = this;
	        this.xhrPending = true;
	        this.xhrSub = this.api.getOrders(maxAgeDays, onlyShipped)
	            .subscribe(function (res) {
	            _this.orders = res.json();
	            _this.extractOrdersStats(_this.orders);
	            _this.xhrPending = false;
	        }, function (err) { return _this.addErrors(err); });
	    };
	    OrdersOverviewComponent.prototype.ngOnInit = function () {
	        this.createForm();
	        this.fetchOrders(/* maxAgeDays */ 7, /* onlyShipped */ false);
	    };
	    OrdersOverviewComponent.prototype.ngOnDestroy = function () {
	        if (this.xhrSub && !this.xhrSub.isUnsubscribed) {
	            this.xhrSub.unsubscribe();
	        }
	    ...
	    OrdersOverviewComponent.prototype.addErrors = function (errorResponse) {
	        console.warn(errorResponse);
	        this.xhrPending = false;
	    };
	    OrdersOverviewComponent = __decorate([
	        core_1.Component({
	            selector: 'j-orders-overview',
	            template: __webpack_require__(910),
	            directives: [forms_1.REACTIVE_FORM_DIRECTIVES, ng_semantic_1.SEMANTIC_COMPONENTS, ng_semantic_1.SEMANTIC_DIRECTIVES],
	            pipes: [shared_1.MomentPipe, shared_1.MomentFromNowPipe],
	            styles: ["\n    .table-segment div.ui.segment { min-height: 200px; }\n    .table-segment tbody { cursor: pointer; }\n  "],
	            encapsulation: core_1.ViewEncapsulation.None
	        }), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof shared_1.ApiService !== 'undefined' && shared_1.ApiService) === 'function' && _a) || Object, (typeof (_b = typeof forms_1.FormBuilder !== 'undefined' && forms_1.FormBuilder) === 'function' && _b) || Object])
	    ], OrdersOverviewComponent);
	    return OrdersOverviewComponent;
	    var _a, _b;
	}());
	exports.OrdersOverviewComponent = OrdersOverviewComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shared_1 = __webpack_require__(163);
	var shared_2 = __webpack_require__(252);
	var textarea_auto_adjust_directive_1 = __webpack_require__(876);
	var EditDetailsComponent = (function () {
	    function EditDetailsComponent(api, fb, appState, sanitizer) {
	        this.api = api;
	        this.fb = fb;
	        this.appState = appState;
	    ...
	    EditDetailsComponent.prototype.onSubmit = function (formValue) {
	        ...
	        if (this.id.value >= 0) {
	            this.xhrSub = this.api.updateProductDetail(this.parentProductId.value, formValue)
	                ...
	                _this.xhrPending = false;
	                _this.notifyCompleted('Markdown updated');
	            }, function (err) {
	                _this.notifyCompleted('Failed to update mardown', false);
	                _this.addErrors(err);
	            });
	        }
	        else {
	            this.xhrSub = this.api.createProductDetail(this.parentProductId.value, formValue)
	                ...
	                _this.createForm(detail);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Markdown created');
	            }, function (err) {
	                _this.notifyCompleted('Failed to create category', false);
	                _this.addErrors(err);
	            });
	    ...
	    EditDetailsComponent.prototype.onPreviewClick = function (formValue) {
	        ...
	        this.xhrSub = this.api.getMarkdownPreview(formValue)
	            .subscribe(function (res) {
	            var markdown = res.json().markdown;
	            _this.preview = _this.sanitizer.bypassSecurityTrustHtml(markdown);
	            _this.xhrPending = false;
	        }, function (err) {
	            _this.notifyCompleted('Failed to fetch markdown', false);
	            _this.addErrors(err);
	        });
	    };
	    EditDetailsComponent.prototype.onPreviewBackClick = function () {
	        this.preview = null;
	    };
	    ...
	    EditDetailsComponent.prototype.createForm = function (productDetail) {
	        ...
	        this.id = new forms_1.FormControl(-1);
	        this.markdown = new forms_1.FormControl('', forms_1.Validators.maxLength(this.markdownMaxLength));
	    ...
	    EditDetailsComponent.prototype.notifyCompleted = function (message, success, durationMs) {
	        var _this = this;
	        if (success === void 0) { success = true; }
	        if (durationMs === void 0) { durationMs = 2500; }
	        this.xhrNotificationVisible = true;
	    ...
	    EditDetailsComponent.prototype.ensureXhrCancelled = function () {
	        if (this.xhrSub && this.xhrSub.unsubscribe && !this.xhrSub.isUnsubscribed) {
	            this.xhrSub.unsubscribe();
	        }
	    };
	    EditDetailsComponent.prototype.addErrors = function (errorResponse) {
	        console.warn(errorResponse);
	        this.xhrPending = false;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditProductComponent = (function () {
	    function EditProductComponent(api, fb, appState) {
	        this.api = api;
	        this.fb = fb;
	        this.appState = appState;
	        this.xhrNotificationTimeoutHandle = null;
	    ...
	    EditProductComponent.prototype.createForm = function (product) {
	        ...
	        this.stockQuantity = new forms_1.FormControl(0, forms_1.Validators.compose([forms_1.Validators.required, forms_1.Validators.pattern('[0-9]+')]));
	        ...
	        this.newProduct = new forms_1.FormControl(false);
	        this.promoActive = new forms_1.FormControl(false);
	    ...
	    EditProductComponent.prototype.onFormSubmit = function (formValue) {
	        ...
	        if (id > 0) {
	            ...
	            this.xhrSub = this.api.updateProduct(formValue)
	                ...
	                var prod = res.json();
	                _this.product = prod;
	                _this.appState.currentProduct = prod;
	                var updatedProductIndex = _this.appState.productSearchResult.findIndex(function (p) { return p.id === id; });
	                _this.appState.productSearchResult.splice(updatedProductIndex, 1, prod);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Product updated');
	            }, function (err) {
	                _this.addErrors(err);
	                _this.notifyCompleted('Failed to update product', false, 4000);
	            });
	        }
	        else {
	            // creating product
	            this.xhrSub = this.api.createProduct(formValue)
	                ...
	                _this.xhrPending = false;
	                _this.notifyCompleted('Product created');
	            }, function (err) {
	                _this.addErrors(err);
	                _this.notifyCompleted('Failed to create product', false, 4000);
	            });
	        }
	    };
	    EditProductComponent.prototype.onDeleteClick = function () {
	        this.showConfirmDelete = true;
	    };
	    EditProductComponent.prototype.onConfirmDeleteOk = function () {
	        var _this = this;
	        this.ensureXhrCancelled();
	        this.xhrPending = true;
	        this.showConfirmDelete = false;
	        ...
	        this.xhrSub = this.api.deleteProduct(id)
	            ...
	            var deletedProductIndex = _this.appState.productSearchResult.findIndex(function (p) { return p.id === id; });
	            _this.appState.productSearchResult.splice(deletedProductIndex, 1);
	            _this.xhrPending = false;
	            _this.notifyCompleted('Product deleted');
	        }, function (err) {
	            _this.notifyCompleted('Failed to delete product', false);
	            _this.addErrors(err);
	        });
	    };
	    EditProductComponent.prototype.onConfirmDeleteCancel = function () {
	        this.showConfirmDelete = false;
	    };
	    EditProductComponent.prototype.onCategorySelect = function (category) {
	        if (category.id === this.parentCategoryId.value || category.manufacturers.length < 1) {
	            return;
	        }
	    ...
	    EditProductComponent.prototype.notifyCompleted = function (message, success, durationMs) {
	        var _this = this;
	        if (success === void 0) { success = true; }
	        if (durationMs === void 0) { durationMs = 2500; }
	        this.xhrNotificationVisible = true;
	    ...
	    EditProductComponent.prototype.ensureXhrCancelled = function () {
	        if (this.xhrSub && this.xhrSub.unsubscribe && !this.xhrSub.isUnsubscribed) {
	            this.xhrSub.unsubscribe();
	        }
	    };
	    ...
	    EditProductComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof shared_1.ApiService !== 'undefined' && shared_1.ApiService) === 'function' && _a) || Object, (typeof (_b = typeof forms_1.FormBuilder !== 'undefined' && forms_1.FormBuilder) === 'function' && _b) || Object, (typeof (_c = typeof shared_2.AdminAppState !== 'undefined' && shared_2.AdminAppState) === 'function' && _c) || Object])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditTagsComponent = (function () {
	    function EditTagsComponent(api, appState) {
	        this.api = api;
	        this.appState = appState;
	        this.addTagSub = null;
	    ...
	    EditTagsComponent.prototype.addTag = function (tag) {
	        ...
	        this.addTagSub = this.api.addTagToProduct(this.product.id, tag.id)
	            .subscribe(function (res) {
	            tag.added = true;
	            _this.appState.currentProduct.tags.push(tag);
	            _this.product = _this.appState.currentProduct;
	        }, function (err) { return _this.addErrors(err); });
	    };
	    EditTagsComponent.prototype.removeTag = function (tag) {
	        ...
	        this.removeTagSub = this.api.removeTagFromProduct(this.product.id, tag.id)
	            .subscribe(function (res) {
	            var tagIndex = _this.appState.currentProduct.tags.findIndex(function (t) { return t.id === tag.id; });
	            ...
	            _this.appState.currentProduct.tags.splice(tagIndex, 1);
	            _this.product = _this.appState.currentProduct;
	        }, function (err) { return _this.addErrors(err); });
	    };
	    ...
	    EditTagsComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof shared_1.ApiService !== 'undefined' && shared_1.ApiService) === 'function' && _a) || Object, (typeof (_b = typeof shared_2.AdminAppState !== 'undefined' && shared_2.AdminAppState) === 'function' && _b) || Object])
	    ], EditTagsComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__export(__webpack_require__(884));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductSearchComponent = (function () {
	    function ProductSearchComponent(api, fb, appState, router) {
	        this.api = api;
	        this.fb = fb;
	        this.appState = appState;
	        this.router = router;
	    ...
	    ProductSearchComponent.prototype.createForm = function () {
	        var _this = this;
	        this.xhrPending = false;
	        this.term = new forms_1.FormControl('', forms_1.Validators.compose([
	            forms_1.Validators.minLength(this.minLength),
	            forms_1.Validators.maxLength(this.maxLength)
	        ]));
	        this.form = this.fb.group({
	            'term': this.term
	        });
	        this.searchSub = this.term.valueChanges
	            ...
	            .do(function () { return _this.xhrPending = true; })
	    ...
	    ProductSearchComponent = __decorate([
	        core_1.Component({
	            ...
	            directives: [forms_1.REACTIVE_FORM_DIRECTIVES, router_1.ROUTER_DIRECTIVES, ng_semantic_1.SEMANTIC_COMPONENTS, ng_semantic_1.SEMANTIC_DIRECTIVES]
	        }), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductsComponent = (function () {
	    function ProductsComponent(appState) {
	        this.appState = appState;
	    }
	    Object.defineProperty(ProductsComponent.prototype, "noneOrNonexistentProduct", {
	        get: function () {
	    ...
	    ProductsComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof shared_1.AdminAppState !== 'undefined' && shared_1.AdminAppState) === 'function' && _a) || Object])
	    ], ProductsComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var core_1 = __webpack_require__(1);
	var AdminAppState = (function () {
	    function AdminAppState() {
	        this.productSearchResult = [];
	        this._currentProduct = null;
	    }
	    AdminAppState.prototype.clearCurrentProduct = function () {
	        this._currentProduct = null;
	    };
	    AdminAppState.prototype.clearProductSearchResult = function () {
	        this.productSearchResult = [];
	    };
	    Object.defineProperty(AdminAppState.prototype, "currentProduct", {
	        get: function () {
	    ...
	    Object.defineProperty(AdminAppState.prototype, "productSelected", {
	        get: function () {
	    ...
	    AdminAppState = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [])
	    ], AdminAppState);
	    return AdminAppState;
	}());
	exports.AdminAppState = AdminAppState;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__export(__webpack_require__(887));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagsComponent = (function () {
	    ...
	    TagsComponent.prototype.onNewTagClick = function (category) {
	    ...
	    TagsComponent.prototype.onFormSubmit = function (formValue) {
	        ...
	        this.xhrPending = true;
	        if (formValue.id >= 0) {
	            this.xhrSub = this.api.updateTag(formValue).subscribe(function (res) {
	                var updatedTag = res.json();
	                var category = _this.categories.find(function (c) { return c.id === updatedTag.parentCategoryId; });
	                var tagIndex = category.tags.findIndex(function (m) { return m.id === updatedTag.id; });
	                category.tags[tagIndex] = updatedTag;
	                _this.onTagClick(_this.selectedCategory, updatedTag);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Tag updated');
	            }, function (err) {
	                _this.notifyCompleted('Failed to update tag', false);
	                _this.addErrors(err);
	            });
	        }
	        else {
	            this.xhrSub = this.api.createTag(formValue).subscribe(function (res) {
	                var createdTag = res.json();
	                var category = _this.categories.find(function (c) { return c.id === createdTag.parentCategoryId; });
	                category.tags.push(createdTag);
	                _this.onTagClick(_this.selectedCategory, createdTag);
	                _this.xhrPending = false;
	                _this.notifyCompleted('Tag created');
	            }, function (err) {
	                _this.notifyCompleted('Failed to create tag', false);
	                _this.addErrors(err);
	            });
	        }
	    };
	    TagsComponent.prototype.onDeleteClick = function () {
	        this.showConfirmDelete = true;
	    };
	    TagsComponent.prototype.onConfirmDeleteOk = function () {
	        var _this = this;
	        this.ensureXhrCancelled();
	        this.xhrPending = true;
	        this.showConfirmDelete = false;
	        var id = this.id.value;
	        this.xhrSub = this.api.deleteTag(id).subscribe(function (res) {
	            ...
	            _this.form = null;
	            _this.xhrPending = false;
	            _this.notifyCompleted('Tag deleted');
	        }, function (err) {
	            _this.notifyCompleted('Failed to delete tag', false);
	            _this.addErrors(err);
	        });
	    };
	    TagsComponent.prototype.onConfirmDeleteCancel = function () {
	        this.showConfirmDelete = false;
	    };
	    ...
	    TagsComponent.prototype.notifyCompleted = function (message, success, durationMs) {
	        var _this = this;
	        if (success === void 0) { success = true; }
	        if (durationMs === void 0) { durationMs = 2500; }
	        this.xhrNotificationVisible = true;
	    ...
	    TagsComponent.prototype.ensureXhrCancelled = function () {
	        if (this.xhrSub && this.xhrSub.unsubscribe && !this.xhrSub.isUnsubscribed) {
	            this.xhrSub.unsubscribe();
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApiService = (function () {
	     ...
	     */
	    ApiService.prototype.searchUserByEmail = function (term) {
	        var _this = this;
	     ...
	     * Orders
	     */
	    ApiService.prototype.getOrders = function (maxAgeDays, onlyShipped) {
	        var _this = this;
	        var queryParams = new http_1.URLSearchParams();
	    ...
	    ApiService.prototype.getOrdersByUserId = function (userId, maxAgeDays) {
	        var _this = this;
	        var queryParams = new http_1.URLSearchParams();
	        queryParams.set('maxAgeDays', JSON.stringify(maxAgeDays));
	        return this.jsonRequest({
	    ...
	    ApiService.prototype.createOrder = function (model) {
	        var _this = this;
	        return this.jsonRequest({
	            method: http_1.RequestMethod.Post,
	    ...
	    ApiService.prototype.acceptOrder = function (orderId) {
	        var _this = this;
	        return this.jsonRequest({
	            method: http_1.RequestMethod.Put,
	    ...
	    ApiService.prototype.cancelOrder = function (orderId) {
	        var _this = this;
	        return this.jsonRequest({
	            method: http_1.RequestMethod.Put,
	    ...
	    ApiService.prototype.markOrderAsShipped = function (orderId) {
	        var _this = this;
	        return this.jsonRequest({
	            method: http_1.RequestMethod.Put,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MomentFromNowPipe = (function () {
	    ...
	    MomentFromNowPipe.prototype.transform = function (value) {
	    ...
	    MomentFromNowPipe = __decorate([
	        core_1.Pipe({ name: 'fromNow', pure: true }), 
	        __metadata('design:paramtypes', [])
	    ], MomentFromNowPipe);
	    return MomentFromNowPipe;
	}());
	exports.MomentFromNowPipe = MomentFromNowPipe;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MomentPipe = (function () {
	    function MomentPipe() {
	        this.shortDateFormat = 'D/M/YYYY';
	        this.longDateFormat = 'D/M/YYYY HH:mm:ss';
	    }
	    MomentPipe.prototype.transform = function (value, type) {
	    ...
	    MomentPipe = __decorate([
	        core_1.Pipe({ name: 'moment', pure: true }), 
	        __metadata('design:paramtypes', [])
	    ], MomentPipe);
	    return MomentPipe;
	}());
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"ui basic segment\">\r\n  <div class=\"ui secondary pointing menu\">\r\n    <a sm-item *ngFor=\"let item of menuitems\" [icon]=\"item.icon\" [routerLink]=\"item.link\" routerLinkActive=\"active\">\r\n    {{ item.title }}\r\n  </a>\r\n  </div>\r\n</div>\r\n\r\n<router-outlet></router-outlet>"
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"ui grid container\">\r\n  <!--left column-->\r\n  <div class=\"four wide column\">\r\n    <div class=\"ui secondary fluid vertical menu\">\r\n      <a class=\"item\" [routerLink]=\" ['./search'] \" routerLinkActive=\"active\">Search</a>\r\n      <a class=\"item\" [routerLink]=\" ['./edit'] \" routerLinkActive=\"active\">Create / Edit</a>\r\n      <a class=\"item\" [routerLink]=\" ['./tags'] \" routerLinkActive=\"active\" [class.disabled]=\"noneOrNonexistentProduct\">Tags</a>\r\n      <a class=\"item\" [routerLink]=\" ['./detail'] \" routerLinkActive=\"active\" [class.disabled]=\"noneOrNonexistentProduct\">Details</a>\r\n    </div>\r\n  </div>\r\n\r\n  <!--content column-->\r\n  <div class=\"twelve wide stretched column\">\r\n    <router-outlet></router-outlet>\r\n  </div>\r\n</div>\r\n"

/***/ },
/* 916 */
/***/ function(module, exports) {

	module.exports = "<div class=\"ui grid container\">\r\n  <!--left column-->\r\n  <div class=\"five wide column\">\r\n\r\n    \r\n    <div class=\"ui minimal comments\">\r\n      \r\n      <div class=\"comment\" *ngFor=\"let category of categories\">\r\n        <div class=\"content\">\r\n          <i class=\"icon hashtag\"></i><strong>{{ category.name }}</strong>\r\n          <div class=\"actions\" style=\"opacity: 1;\">\r\n            <div class=\"ui tiny compact inverted red button\" (click)=\"onNewTagClick(category)\">new</div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class=\"comments\" *ngIf=\"category.tags?.length > 0\">\r\n          <div class=\"comment\" *ngFor=\"let tag of category.tags\" (click)=\"onTagClick(category, tag); $event.stopPropagation()\">\r\n            <div class=\"content\">\r\n              <a class=\"author\" [ngStyle]=\"{'text-decoration': (tag?.id === selectedTag?.id) ? 'underline' : 'none'}\">\r\n                {{ tag.name }}\r\n              </a>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n    </div>\r\n\r\n  </div> <!--end left column-->\r\n\r\n  <!--content column-->\r\n  <div class=\"eleven wide stretched column\">\r\n\r\n    <div class=\"ui small icon message\" style=\"max-height: 4.5rem;\" *ngIf=\"!form && xhrNotificationVisible\" [ngClass]=\"{'positive': xhrSucceeded, 'negative': !xhrSucceeded}\">\r\n      <i class=\"icon\" [ngClass]=\"{'checkmark': xhrSucceeded, 'warning sign': !xhrSucceeded}\"></i>\r\n      <div class=\"content\">\r\n        <div class=\"header\">\r\n          <span *ngIf=\"xhrSucceeded\">Success!</span>\r\n          <span *ngIf=\"!xhrSucceeded\">Error!</span>\r\n        </div>\r\n        <p>{{ xhrNotificationMessage }}</p>      \r\n      </div>\r\n    </div>\r\n\r\n    <form novalidate class=\"ui form attached fluid segment\" *ngIf=\"form\"\r\n      [class.loading]=\"xhrPending\" [formGroup]=\"form\" (ngSubmit)=\"onFormSubmit(form.value)\">      \r\n\r\n      <!--header-->\r\n      <h4 class=\"ui dividing header\">\r\n        <span *ngIf=\"id.value >= 0\">Modifying tag <em>{{ selectedtag?.name }}</em> in category <em>{{ selectedCategory?.name }}</em></span>\r\n        <span *ngIf=\"id.value < 0\">Creating new tag in category <em>{{ selectedCategory.name }}</em></span>\r\n      </h4>\r\n\r\n      <!--name-->\r\n      <div class=\"field\">\r\n        <sm-input label=\"Name ({{ name.value.length }}/{{ fieldRules.name.maxLength }})\" [control]=\"name\"></sm-input>\r\n        <div class=\"ui basic pointing red label\" *ngIf=\"!name.valid && !name.pristine\">        \r\n          <small *ngIf=\"name.hasError('required')\">Name is required<br/></small>\r\n          <small *ngIf=\"name.hasError('minlength')\">Minimum length is {{ fieldRules.name.minLength }}<br/></small>\r\n          <small *ngIf=\"name.hasError('maxlength')\">Maximum length is {{ fieldRules.name.maxLength }}<br/></small>\r\n        </div>\r\n      </div><!--name-->\r\n\r\n      <!--url segment-->\r\n      <div class=\"field\" [class.error]=\"!urlSegment.valid && urlSegment.touched\" [class.success]=\"urlSegment.valid && urlSegment.touched\">\r\n        <sm-input label=\"urlSegment ({{ urlSegment.value.length }}/{{ fieldRules.urlSegment.maxLength }})\" [control]=\"urlSegment\"></sm-input>\r\n        <div class=\"ui basic pointing red label\" *ngIf=\"!urlSegment.valid && !urlSegment.pristine\">        \r\n          <small *ngIf=\"urlSegment.hasError('required')\">Url segment is required<br/></small>\r\n          <small *ngIf=\"urlSegment.hasError('minlength')\">Minimum length is {{ fieldRules.urlSegment.minLength }}<br/></small>\r\n          <small *ngIf=\"urlSegment.hasError('maxlength')\">Maximum length is {{ fieldRules.urlSegment.maxLength }}<br/></small>\r\n        </div>\r\n      </div><!--url segment-->\r\n\r\n      <!--show in main menu-->\r\n      <div class=\"field\">\r\n        <sm-checkbox type=\"toggle\" label=\"Show in main manu\" [control]=\"showInMainMenu\"></sm-checkbox>\r\n      </div>\r\n\r\n      <!--submit button-->\r\n      <button class=\"ui positive button\" [disabled]=\"!form.valid\" [class.loading]=\"xhrPending\">\r\n        <i class=\"ui icon thumbs up\"></i>\r\n        <span *ngIf=\"selectedTag == null\">Create</span>\r\n        <span *ngIf=\"selectedTag != null\">Update</span>\r\n      </button>\r\n\r\n      <!--delete button-->\r\n      <button *ngIf=\"selectedTag && !showConfirmDelete\" class=\"ui red inverted button\" type=\"button\" \r\n        [disabled]=\"id.value < 0\" (click)=\"onDeleteClick()\">\r\n        Delete\r\n      </button>\r\n\r\n      <!--delete confirmation buttons-->\r\n      <div class=\"ui buttons\" *ngIf=\"showConfirmDelete\">\r\n        <div class=\"ui button cancel\" (click)=\"onConfirmDeleteCancel()\">No</div>\r\n        <div class=\"or\"></div>\r\n        <div class=\"ui red inverted button\" (click)=\"onConfirmDeleteOk()\">Yes, delete</div>\r\n      </div>\r\n\r\n    </form>\r\n\r\n    <div class=\"ui bottom attached message\" *ngIf=\"form && xhrNotificationVisible\" [ngClass]=\"{'success': xhrSucceeded, 'error': !xhrSucceeded}\">\r\n      <span *ngIf=\"xhrSucceeded\"><i class=\"icon checkmark\"></i>{{ xhrNotificationMessage }}</span>\r\n      <span *ngIf=\"!xhrSucceeded\"><i class=\"icon warning sign\"></i>{{ xhrNotificationMessage }}</span>\r\n    </div>\r\n\r\n  </div> <!--end content column-->\r\n\r\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(6);
	var distinct_1 = __webpack_require__(920);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ErrorObservable_1 = __webpack_require__(918);
